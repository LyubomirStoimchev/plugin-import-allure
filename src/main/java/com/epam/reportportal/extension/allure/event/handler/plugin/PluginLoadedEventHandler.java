package com.epam.reportportal.extension.allure.event.handler.plugin;

import static com.epam.reportportal.extension.allure.ImportAllurePluginExtension.BINARY_DATA_PROPERTIES_FILE_ID;
