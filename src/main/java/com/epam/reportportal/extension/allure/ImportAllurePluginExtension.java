package com.epam.reportportal.extension.allure;

import com.epam.reportportal.extension.CommonPluginCommand;
import com.epam.reportportal.extension.IntegrationGroupEnum;
import com.epam.reportportal.extension.PluginCommand;
import com.epam.reportportal.extension.ReportPortalExtensionPoint;
import com.epam.reportportal.extension.allure.command.AllureImportCommand;
import com.epam.reportportal.extension.allure.event.plugin.PluginEventHandlerFactory;
import com.epam.reportportal.extension.allure.event.plugin.PluginEventListener;
import com.epam.reportportal.extension.allure.utils.MemoizingSupplier;
...
import static com.epam.reportportal.extension.allure.command.AllureImportCommand.MAX_FILE_SIZE;
import static com.epam.reportportal.extension.util.CommonConstants.*;

@Extension
public class ImportAllurePluginExtension implements ReportPortalExtensionPoint, DisposableBean {

  private static final String PLUGIN_ID = "allure";
  public static final String BINARY_DATA_PROPERTIES_FILE_ID = "binary-data.properties";
  private static final String DESCRIPTION = "Import Allure 2 results from ZIP archives into ReportPortal";
  ...
  private ApplicationContext applicationContext;
    ...
    public ImportAllurePluginExtension(Map<String, Object> initParams) {
  ...
  private Map<String, CommonPluginCommand<?>> getCommonCommands() {
    ...
    var xunitImportCommand = new AllureImportCommand(requestEntityConverter,
